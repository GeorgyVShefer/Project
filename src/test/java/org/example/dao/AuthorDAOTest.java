...
public class AuthorDAOTest {
    ...
    public void setUp() throws Exception {
        ...
        try (Connection connection = connectionUtil.getConnection();
            ...
            statement.execute("CREATE TABLE author (" +
            ...
            statement.execute("INSERT INTO author (name) VALUES " +
                    "('Author1'), ('Author2')");

            statement.execute("INSERT INTO publisher (name) VALUES " +
                    "('Publisher1'), ('Publisher2')");

            statement.execute("INSERT INTO book (title, author_id, publisher_id, publication_year) VALUES " +
    ...
    public void clearDatabase() throws Exception {
        ...
        try (Connection connection = connectionUtil.getConnection();
            ...
            statement.execute("DELETE FROM publisher");
